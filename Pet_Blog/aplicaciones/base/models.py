...
class Post(ModeloBase):
    ...
    duenioMascota = models.ForeignKey(Autor, on_delete=models.CASCADE)
    email = models.EmailField('Correo Electrónico', max_length=200)
    phone = PhoneNumberField(null=False, blank=False, unique=True)
    nombreM = models.CharField('Nombre de la mascota ',max_length = 100)
    edadM = models.PositiveIntegerField(default=0)
    tamaniooM =  models.CharField('tamaño de la mascota ',max_length = 100)
    imagenM = models.ImageField('Imagen Mascota', upload_to='imagenes/', max_length=255)
